...
let neg_def =
  (Pair (vF, (vT::[])))::((Pair (vf, (vt::[])))::((Pair (vf1, (vt1::[])))::((Pair (vt1,
    (vf1::[])))::((Pair (vt, (vf::[])))::((Pair (vT, (vF::[])))::[])))))

(** val box_def : (nat, nat list) pair list **)

let box_def =
  (Pair (vF, (vF::[])))::((Pair (vf, (vF::[])))::((Pair (vf1, (vt1::[])))::((Pair (vt1,
    (vt1::[])))::((Pair (vt, (vF::[])))::((Pair (vT, (vT::[])))::[])))))

(** val dia_def : (nat, nat list) pair list **)

let dia_def =
  (Pair (vF, (vF::[])))::((Pair (vf, (vT::[])))::((Pair (vf1, (vf1::[])))::((Pair (vt1,
    (vf1::[])))::((Pair (vt, (vT::[])))::((Pair (vT, (vT::[])))::[])))))
...
let impl_def =
  (Pair ((Pair (vF, vF)), (vT::[])))::((Pair ((Pair (vF, vf)), (vT::[])))::((Pair ((Pair
    ...
    ((Pair (vt, vf1)), (deadend::[])))::((Pair ((Pair (vt, vt1)),
    (deadend::[])))::((Pair ((Pair (vf1, vt)), (deadend::[])))::((Pair ((Pair (vt1,
    vt)), (deadend::[])))::((Pair ((Pair (vT, vf1)), (deadend::[])))::((Pair ((Pair (vT,
    vt1)), (deadend::[])))::((Pair ((Pair (vf1, vT)), (deadend::[])))::((Pair ((Pair
    (vt1, vT)), (deadend::[])))::[])))))))))))))))))))))))))))))))))))
...
let makeRestrictionSteps a =
  restrictionSteps a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKB45 (S (S (S (S
    (S (S (S (S O)))))))) truleKB45
...
| [] -> []
| n0::tl -> let Node (_, a) = n0 in a::(makeLevel0_aux1 tl)
...
let makeThisRn _ a smallest lazymode =
  rnkripke a (makeMatrix a) eqb_lf leb_lf geb_lf length_lf split_lf arrowsKB45 (S (S (S
    (S (S (S (S (S O)))))))) d0 (Transitive::(Symmetry::[])) smallest lazymode truleKB45
...
let makeCheckAllModels a smallest lazymode =
  checkAllModels a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKB45 val0 (S (S (S
    (S (S (S (S (S O)))))))) (makeAllRn a smallest lazymode) d0 truleKB45
