...
let box_def =
  (Pair (vF, (vF::[])))::((Pair (vf, (vF::[])))::((Pair (vf1, (vt1::[])))::((Pair (vf2,
    (vt2::(vT::[]))))::((Pair (vt2, (vF::[])))::((Pair (vt1, (vt1::[])))::((Pair (vt,
    (vF::[])))::((Pair (vT, (vt2::(vT::[]))))::[])))))))

(** val dia_def : (nat, nat list) pair list **)

let dia_def =
  (Pair (vF, (vf2::(vF::[]))))::((Pair (vf, (vT::[])))::((Pair (vf1, (vf1::[])))::((Pair
    (vf2, (vT::[])))::((Pair (vt2, (vf2::(vF::[]))))::((Pair (vt1, (vf1::[])))::((Pair
    (vt, (vT::[])))::((Pair (vT, (vT::[])))::[])))))))
...
let makeRestrictionSteps a =
  restrictionSteps a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsK5 (S (S (S (S
    (S (S (S (S O)))))))) truleK5
...
let makeThisRn _ a smallest lazymode =
  rnkripke a (makeMatrix a) eqb_lf leb_lf geb_lf length_lf split_lf arrowsK5 (S (S (S (S
    (S (S (S (S O)))))))) d0 (Transitive::[]) smallest lazymode truleK5
...
let makeCheckAllModels a smallest lazymode =
  checkAllModels a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsK5 val0 (S (S (S
    (S (S (S (S (S O)))))))) (makeAllRn a smallest lazymode) d0 truleK5
