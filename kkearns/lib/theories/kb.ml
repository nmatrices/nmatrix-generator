...
let box_def =
  (Pair (vF, (vF::[])))::((Pair (vf, (vF::[])))::((Pair (vf1, (vt1::[])))::((Pair (vf2,
    (vt2::[])))::((Pair (vt2, (vf2::(vf::(vF::[])))))::((Pair (vt1, (vt1::[])))::((Pair
    (vt, (vf2::(vf::(vF::[])))))::((Pair (vT, (vt2::(vt::(vT::[])))))::[])))))))

(** val dia_def : (nat, nat list) pair list **)

let dia_def =
  (Pair (vF, (vf2::(vf::(vF::[])))))::((Pair (vf, (vt2::(vt::(vT::[])))))::((Pair (vf1,
    (vf1::[])))::((Pair (vf2, (vt2::(vt::(vT::[])))))::((Pair (vt2, (vf2::[])))::((Pair
    (vt1, (vf1::[])))::((Pair (vt, (vT::[])))::((Pair (vT, (vT::[])))::[])))))))
...
let makeRestrictionSteps a =
  restrictionSteps a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKB (S (S (S (S
    (S (S (S (S O)))))))) truleKB
...
let makeThisRn _ a smallest lazymode =
  rnkripke a (makeMatrix a) eqb_lf leb_lf geb_lf length_lf split_lf arrowsKB (S (S (S (S
    (S (S (S (S O)))))))) d0 (Symmetry::[]) smallest lazymode truleKB
...
let makeCheckAllModels a smallest lazymode =
  checkAllModels a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKB val0 (S (S (S
    (S (S (S (S (S O)))))))) (makeAllRn a smallest lazymode) d0 truleKB