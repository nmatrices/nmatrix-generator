...
let neg_def =
  (Pair (vF, (vT::[])))::((Pair (vf, (vt::[])))::((Pair (vt,
    (vf::[])))::((Pair (vT, (vF::[])))::[])))

(** val box_def : (nat, nat list) pair list **)

let box_def =
  (Pair (vF, (vF::[])))::((Pair (vf, (vF::[])))::((Pair (vt,
    (vF::(vf::[]))))::((Pair (vT, (vT::(vt::[]))))::[])))

(** val dia_def : (nat, nat list) pair list **)

let dia_def =
  (Pair (vF, (vF::(vf::[]))))::((Pair (vf, (vT::(vt::[]))))::((Pair (vt,
    (vT::[])))::((Pair (vT, (vT::[])))::[])))

(** val impl_def : ((nat, nat) pair, nat list) pair list **)

let impl_def =
  (Pair ((Pair (vF, vF)), (vT::[])))::((Pair ((Pair (vF, vf)),
    (vT::[])))::((Pair ((Pair (vF, vt)), (vT::[])))::((Pair ((Pair (vF, vT)),
    (vT::[])))::((Pair ((Pair (vf, vF)), (vt::[])))::((Pair ((Pair (vf, vf)),
    (vT::(vt::[]))))::((Pair ((Pair (vf, vt)), (vT::(vt::[]))))::((Pair
    ((Pair (vf, vT)), (vT::[])))::((Pair ((Pair (vt, vF)), (vf::[])))::((Pair
    ((Pair (vt, vf)), (vf::[])))::((Pair ((Pair (vt, vt)),
    (vT::(vt::[]))))::((Pair ((Pair (vt, vT)), (vT::[])))::((Pair ((Pair (vT,
    vF)), (vF::[])))::((Pair ((Pair (vT, vf)), (vf::[])))::((Pair ((Pair (vT,
    vt)), (vt::[])))::((Pair ((Pair (vT, vT)), (vT::[])))::[])))))))))))))))

(** val conj_def : ((nat, nat) pair, nat list) pair list **)

let conj_def =
  (Pair ((Pair (vF, vF)), (vF::[])))::((Pair ((Pair (vF, vf)),
    (vF::[])))::((Pair ((Pair (vF, vt)), (vF::[])))::((Pair ((Pair (vF, vT)),
    (vF::[])))::((Pair ((Pair (vf, vF)), (vF::[])))::((Pair ((Pair (vf, vf)),
    (vF::(vf::[]))))::((Pair ((Pair (vf, vt)), (vF::[])))::((Pair ((Pair (vf,
    vT)), (vf::[])))::((Pair ((Pair (vt, vF)), (vF::[])))::((Pair ((Pair (vt,
    vf)), (vF::[])))::((Pair ((Pair (vt, vt)), (vt::[])))::((Pair ((Pair (vt,
    vT)), (vt::[])))::((Pair ((Pair (vT, vF)), (vF::[])))::((Pair ((Pair (vT,
    vf)), (vf::[])))::((Pair ((Pair (vT, vt)), (vt::[])))::((Pair ((Pair (vT,
    vT)), (vT::[])))::[])))))))))))))))
...
let disj_def =
  (Pair ((Pair (vF, vF)), (vF::[])))::((Pair ((Pair (vF, vf)),
    (vf::[])))::((Pair ((Pair (vF, vt)), (vt::[])))::((Pair ((Pair (vF, vT)),
    (vT::[])))::((Pair ((Pair (vf, vF)), (vf::[])))::((Pair ((Pair (vf, vf)),
    (vf::[])))::((Pair ((Pair (vf, vt)), (vT::(vt::[]))))::((Pair ((Pair (vf,
    vT)), (vT::[])))::((Pair ((Pair (vt, vF)), (vt::[])))::((Pair ((Pair (vt,
    vf)), (vT::(vt::[]))))::((Pair ((Pair (vt, vt)), (vT::(vt::[]))))::((Pair
    ((Pair (vt, vT)), (vT::[])))::((Pair ((Pair (vT, vF)), (vT::[])))::((Pair
    ((Pair (vT, vf)), (vT::[])))::((Pair ((Pair (vT, vt)), (vT::[])))::((Pair
    ((Pair (vT, vT)), (vT::[])))::[])))))))))))))))

(** val nmatrix :
    lF -> lF -> lF btree -> nat list -> lF btree list -> lF btree **)
...
(** val makeRestrictionSteps :
    lF -> (lF list, ((nat, nat list) pair list, (nat, (lF, (nat, nat list)
    pair list) pair list) pair list) pair list) pair **)

let makeRestrictionSteps a =
  restrictionSteps a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKTB
    (S (S (S (S (S (S (S (S O)))))))) truleKTB
...
(** val makeThisRn :
    nat -> lF -> bool -> bool -> (nat, (lF node0 list, nat list) pair) pair
    list **)

let makeThisRn _ a smallest lazymode =
  rnkripke a (makeMatrix a) eqb_lf leb_lf geb_lf length_lf split_lf arrowsKTB
    (S (S (S (S (S (S (S (S O)))))))) d0 (Reflexive::(Symmetry::[])) smallest
    lazymode truleKTB
...
(** val makeCheckAllModels :
    lF -> bool -> bool -> ((nat, ((nat, lF list) pair list, lF node0 list)
    pair) pair list, (lF list, (nat, (nat list, bool list) pair) pair list)
    pair) pair **)

let makeCheckAllModels a smallest lazymode =
  checkAllModels a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKTB
    val0 (S (S (S (S (S (S (S (S O)))))))) (makeAllRn a smallest lazymode) d0
    truleKTB
