...
let box_def =
  (Pair (vF, (vf2::(vf::(vF::[])))))::((Pair (vf, (vf2::(vf::(vF::[])))))::((Pair (vf2,
    (vt2::(vt::(vT::[])))))::((Pair (vt2, (vf2::(vf::(vF::[])))))::((Pair (vt,
    (vf2::(vf::(vF::[])))))::((Pair (vT, (vt2::(vt::(vT::[])))))::[])))))

(** val dia_def : (nat, nat list) pair list **)

let dia_def =
  (Pair (vF, (vf2::(vf::(vF::[])))))::((Pair (vf, (vt2::(vt::(vT::[])))))::((Pair (vf2,
    (vt2::(vt::(vT::[])))))::((Pair (vt2, (vf2::(vf::(vF::[])))))::((Pair (vt,
    (vt2::(vt::(vT::[])))))::((Pair (vT, (vt2::(vt::(vT::[])))))::[])))))
...
let makeRestrictionSteps a =
  restrictionSteps a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKD (S (S (S (S
    (S (S (S (S O)))))))) truleKD
...
let makeThisRn _ a smallest lazymode =
  rnkripke a (makeMatrix a) eqb_lf leb_lf geb_lf length_lf split_lf arrowsKD (S (S (S (S
    (S (S (S (S O)))))))) d0 [] smallest lazymode truleKD
...
let makeCheckAllModels a smallest lazymode =
  checkAllModels a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKD val0 (S (S (S
    (S (S (S (S (S O)))))))) (makeAllRn a smallest lazymode) d0 truleKD
