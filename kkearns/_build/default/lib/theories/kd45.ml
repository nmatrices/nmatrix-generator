...
let box_def =
  (Pair (vF, (vF::[])))::((Pair (vf, (vF::[])))::((Pair (vf2, (vT::[])))::((Pair (vt2,
    (vF::[])))::((Pair (vt, (vF::[])))::((Pair (vT, (vT::[])))::[])))))

(** val dia_def : (nat, nat list) pair list **)

let dia_def =
  (Pair (vF, (vF::[])))::((Pair (vf, (vT::[])))::((Pair (vf2, (vT::[])))::((Pair (vt2,
    (vF::[])))::((Pair (vt, (vT::[])))::((Pair (vT, (vT::[])))::[])))))
...
let makeRestrictionSteps a =
  restrictionSteps a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKD45 (S (S (S (S
    (S (S (S (S O)))))))) truleKD45
...
let makeCheckAllModels a smallest lazymode =
  checkAllModels a (makeMatrix a) eqb_lf leb_lf geb_lf split_lf arrowsKD45 val0 (S (S (S
    (S (S (S (S (S O)))))))) (makeAllRn a smallest lazymode) d0 truleKD45
