...
Definition V := [vF; vf; vf1; vt1; vt; vT].
Definition D := [vt; vt1; vT].
Definition F := [vf; vf1; vF].
...
Definition makeThisRn
  ...
  rnkripke
    ...
    8
    D
    [Transitive; Symmetry] (* TODO: Euclidianity *)
    smallest lazymode truleKB45
.
