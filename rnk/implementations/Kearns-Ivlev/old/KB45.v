(**
    ...
    This KB45 is an extension of the adaptation of Kearns-Ivlev tables proposed by Omori & Skurt.
...
(*
Definition V := [vF; vf1; vf; vt1; vt; vT].

Definition D := [vt1; vt; vT].
Definition F := [vf1; vf; vF].
...
Definition V := [vF; vf1; vf; vf2; vt1; vt; vt2; vT].

Definition D := [vt1; vt; vt2; vT].
Definition F := [vf1; vf; vf2; vF].
...
Compute makeComputeTable ((AM)).

Compute List.length (proj_r (makeComputeTable (([] P)))).

Compute List.length (reverseThisList (nodeToNat (makeMatrix (([] P))))).
