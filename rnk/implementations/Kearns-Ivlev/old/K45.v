(**
    ...
    This K45 is an adaptation of Kearns-Ivlev tables and was introduced in "More Modal Semantics Without Possible Worlds" (Omori & Skurt).
...
Definition pos (A : LF) := Some (A, [vf; vf2; vt; vT]).
Definition nec (A : LF) := Some (A, [vt1; vT]).
Definition imp (A : LF) := Some (A, [vf1; vF]).
