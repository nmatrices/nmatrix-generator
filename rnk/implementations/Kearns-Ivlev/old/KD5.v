...
(**
    ...
    This KD5 is an adaptation of Kearns-Ivlev tables and was introduced in "More Modal Semantics Without Possible Worlds" (Omori & Skurt).
...
Definition nec (A : LF) := Some (A, [vt; vt2; vT]).
Definition imp (A : LF) := Some (A, [vf; vf2; vF]).
