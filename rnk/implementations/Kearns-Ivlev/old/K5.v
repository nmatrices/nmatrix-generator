(**
    ...
    This K5 is an adaptation of Kearns-Ivlev tables and was introduced in "More Modal Semantics Without Possible Worlds" (Omori & Skurt).
...
Compute (reverseThisList (nodeToNat (makeMatrix ((AM))))).
