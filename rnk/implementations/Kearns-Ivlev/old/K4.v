(**
   ...
   This K4 is an extension of the adaptation of Kearns-Ivlev tables proposed by Omori & Skurt.
...
Definition nec (A : LF) := Some (A, [vT; vt1]).
Definition imp (A : LF) := Some (A, [vF; vf1]).
