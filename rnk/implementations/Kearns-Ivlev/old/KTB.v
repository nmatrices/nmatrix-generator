(**
   ...
   This KTB (or simply B) is an adaptation of Kearns-Ivlev tables and was proposed in "Finite non-deterministic semantics for some modal systems" (Coniglio et al).
...
v(A) = vf means "A is contingently false" 
v(A) = vt means "A is contingently true"
...
Compute reverseThisList (nodeToNat (makeMatrix (<> P))).
