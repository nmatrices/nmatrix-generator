(**
   ...
   This KB is an extension of the adaptation of Kearns-Ivlev tables proposed by Omori & Skurt.
...
Definition pos (A : LF) := Some (A, [vf2; vf; vt; vT]).
...
Compute (reverseThisList (nodeToNat (makeMatrix ((AB))))).
